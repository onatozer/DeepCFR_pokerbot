...
class DeepInfoSet:
    ...
    #TODO: This needs to be different for leduc/kuhn poker as opposed to uni poker
    #[Round 3][Player: 0][Pot: 540][Money: 1110 930][Private: 7s6h][Public: JhTs8d4s2c][Sequences: cc|cc|cc|cr30r90r270]
